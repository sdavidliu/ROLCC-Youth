...
class FremontA: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        button.addTarget(self, action: #selector(FremontA.tapped), forControlEvents: .TouchUpInside)
    }
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        if (defaults.stringForKey("Favorite") == "FremontA"){
