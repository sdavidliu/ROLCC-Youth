...
class FremontB: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        button.addTarget(self, action: #selector(FremontB.tapped), forControlEvents: .TouchUpInside)
    }
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        if (defaults.stringForKey("Favorite") == "FremontB"){
