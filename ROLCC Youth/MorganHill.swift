...
class MorganHill: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        button.addTarget(self, action: #selector(MorganHill.tapped), forControlEvents: .TouchUpInside)
    }
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        if (defaults.stringForKey("Favorite") == "MorganHill"){
